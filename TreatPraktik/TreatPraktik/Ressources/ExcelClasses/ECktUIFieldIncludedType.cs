...
{
    class ECktUIFieldIncludedType
    {
        readonly WorkSheetktUIFieldIncludedType _fieldIncludedType;
        ...
        public void CreateSheet(Sheets sheets, SpreadsheetDocument spreadsheetDocument, WorkbookPart workbookPart)
        {
            ...
            Sheet sheet = new Sheet
            {
                ...
                SheetId = 10U,
                Name = _fieldIncludedType.SheetName
            };
            sheets.Append(sheet);
        ...
        private void InsertTextIntoCells(SpreadsheetDocument spreadsheetDocument, WorksheetPart worksheetPart)
        {
            ...
            foreach (ktUIFieldIncludedType fieldIncludedType in _fieldIncludedType.ktUIFieldIncludedTypeList)
            {
                //if (columnCount >= 2)
                //{
                    columnCount = 1;
                ...
                string text1 = fieldIncludedType.IncludedTypeID;
                ...
                string text2 = fieldIncludedType.IncludedType;
